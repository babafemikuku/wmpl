...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#f5f0e8]">
      ...
      />
      <div className="relative z-10 container px-3 md:px-6 py-20 text-center">
        <FadeUp>
          <h1 className="text-[40px] md:text-[52px] font-bold text-gray-900 leading-tight mb-6">
        ...
        <FadeUp delay={0.2}>
          <div className="flex justify-center gap-4 lg:mb-14">
            ...
            >
              <Link href="/contact font-bold">See how we work</Link>
            </Button>
          </div>
        </FadeUp>
